"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 4)
...
@dataclass
class QuantConfig_portfolio_markowitz_4:
    model_id: str = 'portfolio_markowitz_4'
