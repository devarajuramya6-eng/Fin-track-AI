"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 21)
...
@dataclass
class QuantConfig_portfolio_markowitz_21:
    model_id: str = 'portfolio_markowitz_21'
