"""
Quantitative Finance Module: Markowitz Mean-Variance Efficient Frontier and Quadratic Programming Optimizer (Variant 26)
...
@dataclass
class QuantConfig_portfolio_markowitz_26:
    model_id: str = 'portfolio_markowitz_26'
