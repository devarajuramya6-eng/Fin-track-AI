"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 15)
...
@dataclass
class QuantConfig_portfolio_markowitz_15:
    model_id: str = 'portfolio_markowitz_15'
