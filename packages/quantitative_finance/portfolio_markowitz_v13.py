"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 13)
...
@dataclass
class QuantConfig_portfolio_markowitz_13:
    model_id: str = 'portfolio_markowitz_13'
