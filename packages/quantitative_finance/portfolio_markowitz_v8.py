"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 8)
...
@dataclass
class QuantConfig_portfolio_markowitz_8:
    model_id: str = 'portfolio_markowitz_8'
