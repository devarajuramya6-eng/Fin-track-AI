"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 23)
...
@dataclass
class QuantConfig_portfolio_markowitz_23:
    model_id: str = 'portfolio_markowitz_23'
