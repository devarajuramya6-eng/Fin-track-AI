"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 20)
...
@dataclass
class QuantConfig_portfolio_markowitz_20:
    model_id: str = 'portfolio_markowitz_20'
