"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 5)
...
@dataclass
class QuantConfig_portfolio_markowitz_5:
    model_id: str = 'portfolio_markowitz_5'
