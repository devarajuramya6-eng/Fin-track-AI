"""
Quantitative Finance Module: Nelson-Siegel-Svensson and Cubic Spline Yield Curve Bootstrapping (Variant 15)
...
@dataclass
class QuantConfig_yield_curve_bootstrapping_15:
    model_id: str = 'yield_curve_bootstrapping_15'
