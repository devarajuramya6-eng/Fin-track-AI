"""
Quantitative Finance Module: Markowitz Mean-Variance Efficient Frontier and Quadratic Programming Optimizer (Variant 31)
...
@dataclass
class QuantConfig_portfolio_markowitz_31:
    model_id: str = 'portfolio_markowitz_31'
