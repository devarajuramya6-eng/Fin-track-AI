"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 6)
...
@dataclass
class QuantConfig_portfolio_markowitz_6:
    model_id: str = 'portfolio_markowitz_6'
