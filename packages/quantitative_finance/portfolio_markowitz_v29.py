"""
Quantitative Finance Module: Markowitz Mean-Variance Efficient Frontier and Quadratic Programming Optimizer (Variant 29)
...
@dataclass
class QuantConfig_portfolio_markowitz_29:
    model_id: str = 'portfolio_markowitz_29'
