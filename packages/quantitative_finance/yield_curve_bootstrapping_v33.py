"""
Quantitative Finance Module: Nelson-Siegel-Svensson and Cubic Spline Yield Curve Bootstrapping (Variant 33)
...
@dataclass
class QuantConfig_yield_curve_bootstrapping_33:
    model_id: str = 'yield_curve_bootstrapping_33'
