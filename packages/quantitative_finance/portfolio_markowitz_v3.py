"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 3)
...
@dataclass
class QuantConfig_portfolio_markowitz_3:
    model_id: str = 'portfolio_markowitz_3'
