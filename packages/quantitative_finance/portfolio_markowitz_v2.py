"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 2)
...
@dataclass
class QuantConfig_portfolio_markowitz_2:
    model_id: str = 'portfolio_markowitz_2'
