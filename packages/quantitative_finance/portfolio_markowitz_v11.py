"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 11)
...
@dataclass
class QuantConfig_portfolio_markowitz_11:
    model_id: str = 'portfolio_markowitz_11'
