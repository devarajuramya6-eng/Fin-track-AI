"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 25)
...
@dataclass
class QuantConfig_portfolio_markowitz_25:
    model_id: str = 'portfolio_markowitz_25'
