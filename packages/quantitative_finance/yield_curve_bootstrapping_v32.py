"""
Quantitative Finance Module: Nelson-Siegel-Svensson and Cubic Spline Yield Curve Bootstrapping (Variant 32)
...
@dataclass
class QuantConfig_yield_curve_bootstrapping_32:
    model_id: str = 'yield_curve_bootstrapping_32'
