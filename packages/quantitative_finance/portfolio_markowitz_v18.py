"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 18)
...
@dataclass
class QuantConfig_portfolio_markowitz_18:
    model_id: str = 'portfolio_markowitz_18'
