"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 1)
...
@dataclass
class QuantConfig_portfolio_markowitz_1:
    model_id: str = 'portfolio_markowitz_1'
