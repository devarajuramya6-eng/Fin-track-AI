"""
Quantitative Finance Module: Nelson-Siegel-Svensson and Cubic Spline Yield Curve Bootstrapping (Variant 6)
...
@dataclass
class QuantConfig_yield_curve_bootstrapping_6:
    model_id: str = 'yield_curve_bootstrapping_6'
