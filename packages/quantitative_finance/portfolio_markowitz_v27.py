"""
Quantitative Finance Module: Markowitz Mean-Variance Efficient Frontier and Quadratic Programming Optimizer (Variant 27)
...
@dataclass
class QuantConfig_portfolio_markowitz_27:
    model_id: str = 'portfolio_markowitz_27'
