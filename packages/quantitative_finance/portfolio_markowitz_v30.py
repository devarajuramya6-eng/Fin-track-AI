"""
Quantitative Finance Module: Markowitz Mean-Variance Efficient Frontier and Quadratic Programming Optimizer (Variant 30)
...
@dataclass
class QuantConfig_portfolio_markowitz_30:
    model_id: str = 'portfolio_markowitz_30'
