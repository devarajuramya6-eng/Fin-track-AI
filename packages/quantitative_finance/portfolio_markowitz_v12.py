"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 12)
...
@dataclass
class QuantConfig_portfolio_markowitz_12:
    model_id: str = 'portfolio_markowitz_12'
