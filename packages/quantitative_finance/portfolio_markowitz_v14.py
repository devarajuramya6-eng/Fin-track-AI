"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 14)
...
@dataclass
class QuantConfig_portfolio_markowitz_14:
    model_id: str = 'portfolio_markowitz_14'
