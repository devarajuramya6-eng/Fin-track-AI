"""
Quantitative Finance Module: Markowitz Efficient Frontier Quadratic Optimizer (Variant 17)
...
@dataclass
class QuantConfig_portfolio_markowitz_17:
    model_id: str = 'portfolio_markowitz_17'
