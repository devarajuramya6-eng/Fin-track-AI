"""
Quantitative Finance Module: Markowitz Mean-Variance Efficient Frontier and Quadratic Programming Optimizer (Variant 28)
...
@dataclass
class QuantConfig_portfolio_markowitz_28:
    model_id: str = 'portfolio_markowitz_28'
